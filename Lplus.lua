...
local function createType (baseTypeTable, typeNameOrForwardDeclare, isInterface)
	...
	---@param fieldType Lplus.AllTypes
...
do
	---@diagnostic disable-next-line
	---@class LplusType: Lplus
	local LplusType = Lplus.ForwardDeclare("System.Type")
	...
	local LplusObject = createType(nil, "System.Object", false)
	local def = LplusObject.define
	...
	def.method("=>", LplusType).getType = function (self)
	...
	def.method("table", "=>", LplusObject).as = function (self, typeTable)
	...
	def.method("table", "=>", LplusObject).cast = function (self, theType)
...
do
	local LplusType = createType(Lplus.Object, "System.Type", false)
	local def = LplusType.define
	...
	def.method("=>", LplusType).getBaseType = function (self)
	...
	def.final("table", "=>", LplusType).fromTypeTable = function (typeTable)
		local typeInfo = LplusType()
